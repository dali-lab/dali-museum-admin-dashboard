...
//   const { data: allResources, isLoading: isResourcesLoading } =
//     getAllResources();
//   const { mutate: mutateCreateResource } = createPostviewImage();
//   const { mutate: mutateGetIndividualResource } = getActivePostviewImage();
...
//         <>
//           <div>
//             {allResources.map((r: IPostviewImage) => (
//               <h5>
//                 {r.id}, {r.title}, {r.description}, {r.value}
//               </h5>
//             ))}
//           </div>
